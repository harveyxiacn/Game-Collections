 ...
 */
public class WishGameTab extends Fragment implements SortListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab_wish_games, container, false);
    ...
    public void onResume() {
        super.onResume();
        Log.i("All wish game tab", "onResume");
        dataSource.open();
        List<Game> gameList = dataSource.getAllWishGames();
        dataSource.close();
